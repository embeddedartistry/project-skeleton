...
* [GitHub Project Page](https://github.com/embeddedartistry/PROJECT/)
* [GitHub Issue Tracker](https://github.com/embeddedartistry/PROJECT/issues)
...
* Filing a new [GitHub Issue](https://github.com/embeddedartistry/PROJECT/issues)
...
I currently need the most help with improving the PROJECT in-source Doxygen documentation and commenting. If you would like to help, please select a header in the `include/` folder and add Doxygen style comments to functions with no documentation.
